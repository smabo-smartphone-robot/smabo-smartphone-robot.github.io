...
また、本ページは「[smabo-app](./smabo-app.md)」のガイドを実施している前提で話を進めます。
...
!!! note 組み立ての際のポイント
    ...
    - ミニブレッドボードは、後ろの粘着テープを使って貼り付けてください
    - バッテリーボックスはsmaboの中に配置し、ジャンプワイヤーのみを外側に出して、ブレッドボードに挿す形にしてください
...
![](../fritzing/svg/esp32_battery_box.svg)
